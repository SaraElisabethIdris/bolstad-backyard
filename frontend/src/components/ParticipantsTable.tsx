      ...
      <table className="w-1/2 table-auto border-collapse text-sm text-black">
        <thead className="bg-white p-2 ">
          <tr>
            ...
            <th className="border-b border-gray-200 p-4 p pb-3 pl-8 text-left font-medium text-gray-900 dark:border-gray-600 dark:text-gray-200">Navn</th>
            <th className="border-b border-gray-200 p-4 pb-3 pl-8 text-left font-medium text-gray-900 dark:border-gray-600 dark:text-gray-200">Klubb</th>
          </tr>
        </thead>
        <tbody>
